        ...
        <>
            <div id="header" className="hero__wrapper">
                <div className="wrapper">
                    <h1 className="heading_primary">Kia Ora, I'm <br /><span className="hero__name triangle"> llana.</span> </h1>
                    <div>
                    ...
                    <svg width="212" height="212" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<defs>
 	<g id="everything">
		...
		<use href="#bubble3"/>	
		<use href="#bubble4"/>	
		<use href="#pill_outline" stroke="#ff7750" stroke-width="10"/>	
	...
	<g id="pill_shadow" filter="url(#labelClip)">
		<use href="#pill_outline" fill="#ff7750" y="128"> 
